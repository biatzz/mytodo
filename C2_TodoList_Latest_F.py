...
import os
def get_todos(filepath="https://github.com/biatzz/mytodo/blob/master/todos.txt"):
...
def write_todos(todos_arg, filepath="https://github.com/biatzz/mytodo/blob/master/todos.txt"):
